...
def hello():
    ...
    if not os.path.isfile(DATABASE):
        result += "Database does not exist. You can <a href='/create_db'>create</a> it now."

    else:
        result += generate_table_active()
        ...
        result += generate_table_inactive()
